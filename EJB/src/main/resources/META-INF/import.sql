...
insert into cf_category(cat_id, cat_name, cat_removed) values (nextval('cat_id_seq'), 'JAVA', FALSE)
insert into cf_category(cat_id, cat_name, cat_removed) values (nextval('cat_id_seq'), 'SQL', FALSE)
insert into cf_category(cat_id, cat_name, cat_removed) values (nextval('cat_id_seq'), 'Elektryka', FALSE)
insert into cf_category(cat_id, cat_name, cat_removed) values (nextval('cat_id_seq'), 'Uslugi', FALSE)
insert into cf_category(cat_id, cat_name, cat_removed) values (nextval('cat_id_seq'), 'Finanse', FALSE)
insert into cf_category(cat_id, cat_name, cat_removed) values (nextval('cat_id_seq'), 'Budownictwo', FALSE)
