...
INSERT INTO cf_contract(con_id, con_description, con_name, con_publish_end, con_publish_start,con_acc_id) VALUES (nextval('con_id_seq'), 'Testowe zlecenie2', 'Opis testowego zlecenia2', now(), now(), 2)

INSERT INTO cf_offer(off_id, off_comment, off_years, off_months, off_days, off_hours, off_offer_price, off_acc_id, off_con_id) VALUES (nextval('off_id_seq'), 'Nic ciekawego', 1, 6, 0, 0, 1200, 2, 1)
INSERT INTO cf_offer(off_id, off_comment, off_years, off_months, off_days, off_hours, off_offer_price, off_acc_id, off_con_id) VALUES (nextval('off_id_seq'), 'Nic ciekawego2', 0, 11, 0, 0, 1100, 1, 2)